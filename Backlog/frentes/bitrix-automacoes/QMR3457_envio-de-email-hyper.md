...
dependencias: []
bloqueia: []
tags: [fonte-quimera, cat-cobranca, cobranca, hyperflow]
---

# QMR3457 — Envio de Email Hyper

## Descrição (espelho — fonte: quimera)

> Origem: Quimera #3457 · categoria: Cobrança
...
- **Quimera:** #3457 (status fonte mapeado → `refinado`)
